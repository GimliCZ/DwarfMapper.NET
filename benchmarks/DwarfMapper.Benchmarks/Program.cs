...
public partial class DwarfM
{
    ...
    public partial BlitDst MapBlit(BlitSrc s);       // Vec3[] → blit fast-path
}
...
// ── Benchmarks: DwarfMapper vs hand-written vs Mapperly vs Mapster vs AutoMapper ─
[MemoryDiagnoser]
...
public class MapperBenchmarks
{
    ...
    public void Setup()
    {
        ...
        // Mapster needs no setup (zero-config runtime mode).
    }
