...
using System;
using DwarfMapper.Extensions;            // surfaces the generated model.ToPersonDto() extension
using DwarfMapper.Gallery.Ex15.Models;   // Person
using DwarfMapper.Gallery.Ex15.Dtos;     // PersonDto (carries its own mapping)
...
public static class Example
{
    ...
    {
        Person model = new Person { Name = "John Doe", Age = 100 };

        PersonDto dto = model.ToPersonDto();
