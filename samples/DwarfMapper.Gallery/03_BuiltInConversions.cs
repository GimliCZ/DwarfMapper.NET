...
public enum Rank { Miner, Smith, Lord }
public enum RankDto { Miner, Smith, Lord }

public sealed class Hero { public int Level { get; set; } public Rank Rank { get; set; } }
public sealed class HeroDto { public long Level { get; set; } public RankDto Rank { get; set; } }
...
public static class Example
{
    ...
    {
        HeroDto dto = new Mapper().ToDto(new Hero { Level = 7, Rank = Rank.Smith });
