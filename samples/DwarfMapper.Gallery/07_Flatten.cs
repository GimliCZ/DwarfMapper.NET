...
public sealed class Address { public string City { get; set; } = ""; public string Zip { get; set; } = ""; }
public sealed class Person { public string Name { get; set; } = ""; public Address Address { get; set; } = new(); }
...
public static class Example
{
    ...
    {
        PersonDto dto = new Mapper().ToDto(new Person { Name = "Óin", Address = new Address { City = "Ered Luin", Zip = "0001" } });
