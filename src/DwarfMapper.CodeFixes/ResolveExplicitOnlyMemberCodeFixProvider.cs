...
namespace DwarfMapper.CodeFixes
{
    ...
    ///         <item>
    ///             <description>
    ///                 <b>Map it</b> — insert <c>[MapProperty("Member", "Member")]</c>. A same-named
    ///                 source is known to exist (that is what raised DWARF072), so the scaffold compiles as-is.
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description><b>Ignore it</b> — insert <c>[MapIgnore("Member")]</c>.</description>
    ///         </item>
    ///     </list>
    ...
    public sealed class ResolveExplicitOnlyMemberCodeFixProvider : CodeFixProvider
    {
            ...
            foreach (var diagnostic in context.Diagnostics)
            {
                ...
                context.RegisterCodeFix(
                    CodeAction.Create(
                        ...
                        _ => Task.FromResult(WithAttribute(context.Document,
                            root,
                            captured,
                            "global::DwarfMapper.MapProperty",
                            member,
                            member)),
        ...
        private static Document WithAttribute(
            Document document,
            SyntaxNode root,
            MethodDeclarationSyntax method,
            string attributeType,
            params string[] literalArgs)
        {
