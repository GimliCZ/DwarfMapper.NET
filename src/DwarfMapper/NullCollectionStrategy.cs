...
public enum NullCollectionStrategy
{
    ...
    ///     member must then be nullable — a nullable reference or a nullable value-type collection like
    ///     <c>ImmutableArray&lt;T&gt;?</c>; a non-nullable target silently degrades to AsEmpty).  Re-enumeration of a lazy
