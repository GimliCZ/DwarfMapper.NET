...
namespace DwarfMapper
{
    ...
    ///     members with type-safe selector lambdas; the DwarfMapper generator reads the method's body
    ///     <b>syntactically
    ...
    public sealed class MapConfig<TSource, TTarget>
    {
        ...
        public MapConfig<TSource, TTarget> Map<TSrcMember, TTgtMember>(
            Func<TTarget, TTgtMember> target,
            Func<TSource, TSrcMember> source,
            Func<TSrcMember, TTgtMember> convert) => this;
        ...
        public MapConfig<TSource, TTarget> MapWhen<TMember>(
            Func<TTarget, TMember> target,
            Func<TSource, TMember> source,
            Func<TSource, bool> when) => this;
