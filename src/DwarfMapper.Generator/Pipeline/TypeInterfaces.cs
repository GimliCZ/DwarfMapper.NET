    ...
    internal static class TypeInterfaces
    {
        ...
        internal static bool ImplementsIParsable(Compilation compilation, ITypeSymbol t)
        {
            ...
            return t.AllInterfaces.Any(i =>
                SymbolEqualityComparer.Default.Equals(i.OriginalDefinition, parsableOpen) && i.TypeArguments.Length == 1 && SymbolEqualityComparer.Default.Equals(i.TypeArguments[0], t));
        }
