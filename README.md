...
- **In-repo BenchmarkDotNet suite** (`benchmarks/DwarfMapper.Benchmarks`): DwarfMapper vs. hand-written **and vs. Mapperly / Mapster / AutoMapper 14** across flat / nested / collection / blit scenarios (see [`docs/COMPARISON.md`](docs/COMPARISON.md) for the full capability/testing/migration comparison, and [`docs/MIGRATION.md`](docs/MIGRATION.md) for the feature-by-feature conversion guide from AutoMapper 14 / Mapster / Mapperly); builds in CI, run locally for numbers
