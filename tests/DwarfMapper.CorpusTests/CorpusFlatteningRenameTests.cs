...
public class CorpusFlatteningRenameTests
{
    ...
    public void S01_Basic_nested_flatten()
    {
        var d = new Cf_OrderMapper().Map(new Cf_Order
            { Customer = new Cf_Customer { Name = "Ada Lovelace", Email = "ada@x.io" }, Amount = 42.50m });
    ...
    public void S04_Deep_three_level_flatten()
    {
        var d = new Cf_DeepMapper().Map(new Cf_DeepSrc
            { Customer = new Cf_Cust2 { Address = new Cf_Address { City = "Prague", Country = "CZ" } } });
    ...
    public void S14_15_Drops_nav_and_sensitive_keeps_fk()
    {
        ...
        {
            Id = 1, Name = "Mug", Price = 9.99m, CatalogBrandId = 4, CatalogBrand = new Cf_Brand { BrandName = "ACME" },
