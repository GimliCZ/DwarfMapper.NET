    ...
    public class BacklogCTests
    {
        ...
        public void C5_nullable_int_to_nonnullable_long_projection_is_now_refused()
        {
            ...
            Assert.Contains(reported,
                d =>
                    d.GetMessage(CultureInfo.InvariantCulture).Contains("null decision", StringComparison.Ordinal) && d.GetMessage(CultureInfo.InvariantCulture).Contains("nullable", StringComparison.Ordinal));
        }
