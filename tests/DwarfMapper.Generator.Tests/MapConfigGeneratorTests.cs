...
namespace DwarfMapper.Generator.Tests
{
    ...
    public class MapConfigGeneratorTests
    {
        ...
        private static Diagnostic? D068(IEnumerable<Diagnostic> diags)
        {
            return diags.FirstOrDefault(d => d.Id == "DWARF068");
        }

        private static Diagnostic? D069(IEnumerable<Diagnostic> diags)
        {
            return diags.FirstOrDefault(d => d.Id == "DWARF069");
        }
        ...
        /// <summary>
        ///     DWARF068: an inline converter lambda (not a method group) in the 3-arg <c>.Map</c> overload
        ///     must be rejected by <c>TryReadMethodGroup</c> and reported.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     DWARF069: two <c>.Map</c> calls within the SAME config method targeting the same destination
        ///     member ('A' on D) — a config-vs-config collision.
        /// </summary>
        [Fact]
        ...
        /// <summary>
        ///     DWARF056 reuse: a <c>MapConfig&lt;S,Other&gt;</c> convention method targets a type pair
        ...
        ///     an attribute-origin one, since config entries carry the same Consumed flag through pairProps.
        /// </summary>
        [Fact]
