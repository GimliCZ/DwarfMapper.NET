    ...
    public class GateBandLogicTests
    {
        ...
        public void The_band_functions_fail_below_the_floor_fail_a_quantum_above_it_and_pass_within_it()
        {
            ...
            try
            {
                ...
                WriteTemp(Path.Combine(dir, "report-below.json"), FakeReport(140, 0, 50, 11));
                WriteTemp(Path.Combine(dir, "report-within.json"), FakeReport(143, 1, 46, 11));
                WriteTemp(Path.Combine(dir, "report-above.json"), FakeReport(146, 0, 44, 11));
                ...
                var cases = PwshBattery.Run(dir, 7, "the R2 gate-band functions");
