...
namespace DwarfMapper.Generator.Tests.SelfValidation
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description><c>CollectionConverter.CountKind</c> (None/Length/Count) — drives capacity pre-sizing;</description>
    ///         </item>
    ///         <item>
    ///             <description><c>DictionaryConverter.DictTargetKind</c> — the dictionary target taxonomy;</description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 <c>DwarfMapper.Generator.Model.NullHandling</c>
    ///                 (None/ThrowIfNull/ValueOrDefault/NullableProject/NullableProjectRef)
    ///                 — each value emits distinct null-handling code.
    ///             </description>
    ///         </item>
    ///     </list>
    ...
    public class InternalEnumCoverageSelfValidationTests
    {
        ...
        public void Every_value_of_an_internal_behaviour_enum_is_referenced_in_generator_source(string metadataName)
        {
            ...
            Assert.True(enumType is { IsEnum: true },
                $"Internal enum '{metadataName}' not found in the generator assembly — the taxonomy moved; update " + "this self-validation.");
