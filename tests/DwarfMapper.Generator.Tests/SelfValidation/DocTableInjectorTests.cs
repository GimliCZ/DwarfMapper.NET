...
namespace DwarfMapper.Generator.Tests.SelfValidation
{
    ...
    public class DocTableInjectorTests
    {
        ...
        {
            var ex = Assert.Throws<DocToolingException>(() => DocTableInjector.Inject("Just prose.\n", "options", ["| row |"], "d.md"));
        ...
        public void An_unclosed_table_is_refused_not_truncated()
        {
            ...
            var ex = Assert.Throws<DocToolingException>(() => DocTableInjector.Inject(doc, "options", ["| row |"], "d.md"));
        ...
        public void Null_arguments_throw_with_the_offending_parameter_named()
        {
            ...
            var exMarkdown = Assert.Throws<ArgumentNullException>(() => DocTableInjector.Inject(null!, "options", ["| row |"], "d.md"));
            var exRows = Assert.Throws<ArgumentNullException>(() => DocTableInjector.Inject(doc, "options", null!, "d.md"));
