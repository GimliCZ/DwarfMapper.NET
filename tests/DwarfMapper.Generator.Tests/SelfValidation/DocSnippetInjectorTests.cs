...
namespace DwarfMapper.Generator.Tests.SelfValidation
{
    ...
    public class DocSnippetInjectorTests
    {
        ...
        {
            return rs.ToDictionary(r => r.Id, r => new SnippetRegion(r.Id, r.Body, "F.cs", 1), StringComparer.Ordinal);
        }
        ...
        public void Null_arguments_throw_with_the_offending_parameter_named()
        {
            ...
            var exMarkdown = Assert.Throws<ArgumentNullException>(() => DocSnippetInjector.Inject(null!, Regions(("demo", "x")), "d.md"));
            var exRegions = Assert.Throws<ArgumentNullException>(() => DocSnippetInjector.Inject("<!-- snippet: demo -->\n<!-- endsnippet -->\n", null!, "d.md"));
