...
public static class RepoPaths
{
    ...
    [System.Diagnostics.CodeAnalysis.SuppressMessage("Performance", "CA1819:Properties should not return arrays",
        Justification = "A small, fixed, read-only set of paths consumed by index — mutability of the backing "
        + "array is not a real risk in a test-only static catalogue.")]
