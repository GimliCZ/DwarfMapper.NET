...
namespace DwarfMapper.Generator.Tests
{
    ...
    public class AssemblyDefaultsTests
    {
        ...
        {
            return CaseDiffering.Replace("{ASM}", asm, StringComparison.Ordinal)
                .Replace("{MAPPER}", mapper, StringComparison.Ordinal);
        }
        ...
        public void Built_in_default_applies_when_neither_sets_the_option()
        {
            ...
            Assert.Contains("DWARF001", Ids(Build("", "")));
        }
        ...
        public void Assembly_default_applies_when_the_mapper_does_not_override()
        {
            ...
            var ids = Ids(Build(
                "[assembly: DwarfMapper.DwarfMapperDefaults(CaseInsensitive = true)]",
                ""));
