...
#pragma warning disable CA1062
    public class FeatureCombinationInvalidTests
    {
        public static IEnumerable<object[]> InvalidCombos()
        {
            ...
            yield return Case("strict_narrow",
                "DWARF038",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("strict_parse",
                "DWARF038",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("strict_crosscat",
                "DWARF038",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("byname_misaligned_enum",
                "DWARF015",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("flexible_collision",
                "DWARF048",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("unflatten_x_when",
                "DWARF045",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("unflatten_x_nullsubst",
                "DWARF045",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("mapvalue_x_mapproperty",
                "DWARF042",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("nullsubst_x_converter",
                "DWARF049",
                """
                using DwarfMapper;
                #nullable enable
            ...
            yield return Case("when_bad_predicate",
                "DWARF050",
                """
                using DwarfMapper;
                namespace Iz;
            ...
            yield return Case("duplicate_mapproperty",
                "DWARF011",
                """
                using DwarfMapper;
                namespace Iz;
        ...
        public void Invalid_combination_is_caught_with_exact_diagnostic(string label, string expectedId, string source)
        {
            ...
            Assert.True(diags.Any(d => d.Id == expectedId),
                $"Expected diagnostic {expectedId} for invalid combination '{label}', but got: " + (diags.Length == 0 ? "(none)" : string.Join(", ", diags.Select(d => d.Id).Distinct())));
        }
    }
}
