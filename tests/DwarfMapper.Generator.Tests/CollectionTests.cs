...
public class CollectionTests
{
    ...
    public void List_element_conversion_presizes_from_source_count()
    {
        ...
        Assert.Contains("var __r = new global::System.Collections.Generic.List<global::Demo.InnerD>(src.Count)", gen,
    ...
    public void Array_to_list_element_conversion_presizes_from_length()
    {
        ...
        NoErrors(s);
        var (_, gen) = GeneratorTestHarness.Run(s);
        Assert.Contains("new global::System.Collections.Generic.List<global::Demo.InnerD>(src.Length)", gen,
            StringComparison.Ordinal);
    }
    ...
    public void HashSet_element_conversion_presizes_from_source_count()
    {
        ...
        NoErrors(s);
        var (_, gen) = GeneratorTestHarness.Run(s);
        Assert.Contains("new global::System.Collections.Generic.HashSet<global::Demo.InnerD>(src.Count)", gen,
            StringComparison.Ordinal);
    }
