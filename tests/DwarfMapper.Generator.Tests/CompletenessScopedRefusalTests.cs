...
public class CompletenessScopedRefusalTests
{
    ...
    ///     withholding it made a sibling's <c>N = Map(o.N)</c> emit <b>CS0103, "the name 'Map' does not exist
    ...
    public void An_incomplete_GenerateMap_pair_still_kills_the_whole_class()
    {
        ...
        Assert.DoesNotContain(
            GeneratorTestHarness.EmitAssembly(code).Errors, e => e.Id == "CS0103");
    }
    ...
    [InlineData("public partial System.Collections.Generic.IAsyncEnumerable<Y> Bad("
                + "System.Collections.Generic.IAsyncEnumerable<B> b);")]
    ...
    [InlineData("public sealed class PDst { public int Id { get; set; } public int Missing { get; set; } "
                + "public System.Collections.Generic.HashSet<int> Tags { get; set; } = new(); }")]
