    ...
    public class RegistryInheritanceTests
    {
        ...
        public void An_inherited_destination_member_is_mapped()
        {
            ...
            Assert.True(generated.Contains("Id = source.Id,", StringComparison.Ordinal),
                "The inherited destination member 'Id' was never assigned, so it silently stays at its default. " + "The registry enumerates only type.GetMembers() and does not walk the base-type chain.\n\n" + "--- generated ---\n" + generated);
        }
        ...
        public void An_inherited_source_member_does_not_produce_a_spurious_DWARFR02()
        {
            ...
            Assert.True(generated.Contains("Id = source.Id,", StringComparison.Ordinal),
                "The inherited source member 'Id' was never read, so Dto.Id was never assigned. " + "Absence of DWARFR02 alone doesn't prove the mapping happened — nothing being generated at all " + "would also pass that assertion.\n\n--- generated ---\n" + generated);
        }
    }
}
