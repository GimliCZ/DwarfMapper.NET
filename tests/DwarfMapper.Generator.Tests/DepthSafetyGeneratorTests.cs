    ...
    public class DepthSafetyGeneratorTests
    {
        ...
        public void Public_Map_method_signature_is_unchanged_no_ctx_param()
        {
            ...
            var publicMap = generated
                .Split('\n')
                .FirstOrDefault(l => l.Contains("public partial", StringComparison.Ordinal) && l.Contains("Map(", StringComparison.Ordinal) && l.Contains("NodeDto", StringComparison.Ordinal));
