    ...
    public class DirectiveEndpointReachTests
    {
        ...
        public void The_element_wise_endpoints_alone_claim_the_create_map_is_reached_from_here()
        {
            ...
            foreach (var signature in new[]
                     {
                         "public partial void MapSpan(ReadOnlySpan<Src> s, Span<Dst> d);", "public partial IAsyncEnumerable<Dst> MapStream(IAsyncEnumerable<Src> s);"
                     })
            ...
            foreach (var signature in new[]
                     {
                         "public partial void Update(Src s, Dst d);", "public partial IQueryable<Dst> Project(IQueryable<Src> q);"
                     })
        ...
        public void A_directive_naming_members_that_do_not_exist_is_still_reported_and_echoed_verbatim()
        {
            ...
            Assert.Contains("[FlattenGraph(\"NoSuchNavigation\", \"NoSuchCollection\")]",
                message,
        ...
        public void The_open_form_is_refused_at_all_four_endpoints_that_are_not_a_create_map()
        {
            foreach (var signature in new[]
                     {
                         "public partial void Update(Src s, Dst d);", "public partial IQueryable<Dst> Project(IQueryable<Src> q);", "public partial void MapSpan(ReadOnlySpan<Src> s, Span<Dst> d);", "public partial IAsyncEnumerable<Dst> MapStream(IAsyncEnumerable<Src> s);"
                     })
        ...
        public void A_dispatch_arm_naming_a_type_that_is_not_assignable_is_still_reported_and_never_crashes()
        {
            ...
            Assert.Contains("[MapDerivedType(typeof(string), typeof(DstDerived))]",
                message,
                StringComparison.Ordinal);
        }
            ...
            string endpointName)
        {
            ...
            Assert.DoesNotContain("so that create map is what this method's loop calls",
                message,
                StringComparison.Ordinal);
        }
