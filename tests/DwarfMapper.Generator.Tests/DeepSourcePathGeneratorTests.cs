...
#pragma warning disable CA1305
    ...
    public void Paths_of_varying_depth_compile(int depth)
    {
        ...
        {
            var next = i < depth - 1 ? $"public N{i + 1} Next {{ get; set; }} = new();" : "public string Value { get; set; } = \"\";";
        ...
        sb.AppendLine($"[DwarfMapper] public partial class M {{ [MapProperty(\"{path}\", nameof(D.Leaf))] public partial D Map(S s); }}");
        var src = sb.ToString();
