...
public class ReverseMapCodeFixTests
{
    ...
    public async Task DWARF052_fix_inserts_an_inverse_that_resolves_the_diagnostic()
    {
        ...
        Assert.Contains("partial Entity FromDto", fixedText, System.StringComparison.Ordinal);
        Assert.Contains("Dto source", fixedText, System.StringComparison.Ordinal);
    ...
    public async Task DWARF001_fix_inserts_MapIgnore_that_resolves_the_diagnostic()
    {
        ...
        Assert.Contains("Extra", fixedText, System.StringComparison.Ordinal);
