...
namespace DwarfMapper.Generator.Tests.Framework
{
    ...
    internal static class GeneratorRegistry
    {
        ...
        {
            new GeneratorUnderTest("DwarfGenerator", () => new DwarfGenerator(), DwarfGenerator.AllStepNames), new GeneratorUnderTest("MapToGenerator", () => new MapToGenerator(), MapToGenerator.AllStepNames)
        };
    }
}
