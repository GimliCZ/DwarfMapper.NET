...
public class ConverterHardeningTests
{
    ...
    {
        var (diags, _) = GeneratorTestHarness.Run(MoneyMap("explicit", strict: false));
    ...
    {
        var (diags, _) = GeneratorTestHarness.Run(MoneyMap("implicit", strict: false));
    ...
    {
        var diags = GeneratorTestHarness.Run(MoneyMap("explicit", strict: true)).Diagnostics;
