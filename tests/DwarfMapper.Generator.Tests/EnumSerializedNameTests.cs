...
namespace DwarfMapper.Generator.Tests
{
    ...
    public class EnumSerializedNameTests
    {
        ...
        public void Enum_to_string_emits_the_serialized_name_with_correct_precedence()
        {
            ...
            Assert.Contains("=> \"em\"", generated, StringComparison.Ordinal); // EnumMember beats Description
            Assert.Contains("=> \"d2\"", generated, StringComparison.Ordinal); // Description
            Assert.Contains("=> \"Plain\"", generated, StringComparison.Ordinal); // identifier fallback
            Assert.DoesNotContain("=> \"desc\"", generated, StringComparison.Ordinal); // Description lost to EnumMember
        }
