...
namespace DwarfMapper.Generator.Tests.Fuzzing
{
    ...
    public class FlattenGraphFuzzTests
    {
        ...
        public static IEnumerable<object[]> HomoSeeds()
        {
            ...
            return Enumerable.Range(0, DeepTier.Count(DeepPopulation.FlattenHomoSeeds)).Select(i => new object[]
            {
                i
            });
        }
        ...
        public static IEnumerable<object[]> HeteroSeeds()
        {
            ...
            return Enumerable.Range(0, DeepTier.Count(DeepPopulation.FlattenHeteroSeeds)).Select(i => new object[]
            {
                i
            });
        }
        ...
        public void FlattenGraph_homo_reachability_oracle(int seed)
        {
            ...
            // Map
            var rootDto = mapMethod.Invoke(mapper,
                new[]
                {
                    root
                })!;
        ...
        public void FlattenGraph_hetero_reachability_oracle(int seed)
        {
            ...
            object MakeNode(int v)
            {
                ...
                if (t == fileType)
                {
                    fileType.GetProperty("Size")!.SetValue(n, (long)(v * 100));
                }
            ...
            try
            {
                rootDto = mapMethod.Invoke(mapper,
                    new[]
                    {
                        root
                    })!;
