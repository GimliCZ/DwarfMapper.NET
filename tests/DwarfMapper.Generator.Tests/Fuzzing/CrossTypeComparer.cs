...
namespace DwarfMapper.Generator.Tests.Fuzzing
{
    ...
    internal static class CrossTypeComparer
    {
        ...
        {
            return t.IsPrimitive || t.IsEnum || t == typeof(decimal) || t == typeof(Guid) || t == typeof(DateTime) || t == typeof(DateTimeOffset) || t == typeof(TimeSpan);
        }
