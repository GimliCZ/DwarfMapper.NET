...
namespace DwarfMapper.Generator.Tests.Fuzzing
{
    ...
    public class FixtureHarnessTests
    {
        ...
        public void Shrinker_reduces_a_failure_to_its_essential_member()
        {
            ...
            var start = Fixture.FromSeed(3, 12) with
            {
            ...
            var probes = 0;
            var shrunk = FixtureShrinker.Shrink(start,
                f =>
                {
                    probes++;
        ...
        public void Shrinker_preserves_the_failure_it_was_given()
        {
            ...
            if (!Oracle(start))
            {
                return; // this seed has no List member; nothing to shrink
            }
        ...
        public void A_fixture_shaped_mapper_behaves_consistently_across_endpoints(int seed)
        {
            ...
            foreach (var endpoint in new[]
                     {
                         Endpoint.CreateMap, Endpoint.UpdateInto, Endpoint.Projection
                     })
            {
                var src = fixture.Render().Replace(
                    ...
                    endpoint switch
                    {
                        ...
                        _ => "public partial class M { public partial System.Linq.IQueryable<Dst> Project(" + "System.Linq.IQueryable<Src> q); }"
                    },
