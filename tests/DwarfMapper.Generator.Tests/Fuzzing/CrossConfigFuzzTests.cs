...
namespace DwarfMapper.Generator.Tests.Fuzzing
{
    ...
    public class CrossConfigFuzzTests
    {
        ...
        {
            "CaseInsensitive = true", "SkipNullSourceMembers = true", "AllowNonPublic = true", "ImplicitConversions = false", "ReferenceHandling = global::DwarfMapper.ReferenceHandlingStrategy.Preserve", "OnCycle = global::DwarfMapper.OnCycleStrategy.SetNull", "NullCollections = global::DwarfMapper.NullCollectionStrategy.AsNull",
            "NameConvention = global::DwarfMapper.NameConvention.Flexible", "EnumStrategy = global::DwarfMapper.EnumStrategy.ByValue", "NullStrategy = global::DwarfMapper.NullStrategy.SetDefault"
        };
        ...
        public static IEnumerable<object[]> Pairs()
        {
            ...
            for (var j = i + 1; j < ConfigFragments.Length; j++)
                ...
                {
                    ConfigFragments[i], ConfigFragments[j], i * 100 + j
                };
        }
        ...
        {
            return from seed in Enumerable.Range(0, DeepTier.Count(DeepPopulation.CrossConfigUpdateSeeds))
                from cfg in new[]
                {
                    "ReferenceHandling = global::DwarfMapper.ReferenceHandlingStrategy.Preserve", "OnCycle = global::DwarfMapper.OnCycleStrategy.SetNull"
                }
                select new object[]
                {
                    seed, cfg
