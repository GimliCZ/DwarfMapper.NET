    ...
    public class SourceCoverageGeneratorTests
    {
        ...
        public void Coverage_check_does_not_change_emitted_code()
        {
            ...
            const string baseSrc = """
                                   ...
                                   public class D { public int Id { get; set; } }
                                   """;
            var (_, genTarget) = GeneratorTestHarness.Run(baseSrc + "[DwarfMapper] public partial class M { public partial D Map(S s); }");
            var (_, genBoth) = GeneratorTestHarness.Run(baseSrc + "[DwarfMapper(RequiredMapping = RequiredMappingStrategy.Both)] public partial class M { public partial D Map(S s); }");
