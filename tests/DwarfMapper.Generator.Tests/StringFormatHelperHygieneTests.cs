...
public class StringFormatHelperHygieneTests
{
    ...
    public void The_converter_a_StringFormat_replaced_is_not_emitted_beside_it()
    {
        ...
        Assert.True(orphans.Count == 0,
            "The generator emitted private static helper(s) that nothing calls — B17. "
            + "A StringFormat replaces the converter its member resolved to, and the replaced one must not "
            + "stay in the synthesized table:\n  "
