...
public class FcStoreItem { public string Name { get; set; } = ""; public int Price { get; set; } }
...
public class FcMsgSrc { public string Text { get; set; } = ""; }
public class FcMsgDst { public string Text { get; set; } = ""; }
...
public enum FcPlatform { YouTube, Twitch }

public abstract class FcClient { public string Color { get; set; } = ""; }
public sealed class FcYt : FcClient { }
public sealed class FcTw : FcClient { }
public class FcYtDoc { public string Color { get; set; } = ""; }
public class FcTwDoc { public string Color { get; set; } = ""; }

public class FcAlertsDoc { public FcYtDoc? YouTube { get; set; } public FcTwDoc? Twitch { get; set; } }
public class FcAlerts { public Dictionary<FcPlatform, FcClient> ClientAlerts { get; set; } = new(); }
...
public sealed class FcBasic : FcNote { public string Msg { get; set; } = ""; }
public sealed class FcEmbed : FcNote { public string Title { get; set; } = ""; }
public class FcNoteDto { }
public sealed class FcBasicDto : FcNoteDto { public string Msg { get; set; } = ""; }
public sealed class FcEmbedDto : FcNoteDto { public string Title { get; set; } = ""; }
