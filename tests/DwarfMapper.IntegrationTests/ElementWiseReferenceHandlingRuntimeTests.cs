...
public class ElementWiseReferenceHandlingRuntimeTests
{
    ...
    {
        var shared = new EwrElem { Id = 1, Child = new EwrChild { V = 7 } };
        var other = new EwrElem { Id = 2 };
        var src = new[] { shared, other, shared };
    ...
    {
        var child = new EwrChild { V = 9 };
        var src = new[] { new EwrElem { Id = 1, Child = child }, new EwrElem { Id = 2, Child = child } };
    ...
    public void None_span_maps_a_recursive_element_pair()
    {
        ...
        var chain = new EwrNode { V = 1, Next = new EwrNode { V = 2 } };
        var src = new[] { chain };
