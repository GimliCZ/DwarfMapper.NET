...
// ── Tests ─────────────────────────────────────────────────────────────────────
    ...
    public class ParsableConversionRuntimeTests
    {
        ...
        {
            var result = new StringToIntMapper2().Map(new StringSrc
            {
                V = "42"
            });
        ...
        public void String_to_Guid_round_trips()
        {
            ...
            var result = new StringToGuidMapper().Map(new StringSrc
            {
                V = g.ToString()
            });
        ...
        {
            var result = new IntToStringMapper().Map(new IntSrc3
            {
                V = 42
            });
            Assert.Equal("42", result.V);
        ...
        {
            var g = new Guid("12345678-1234-5678-1234-567812345678");
            var result = new GuidToStringMapper().Map(new GuidSrc
            {
                V = g
            });
        ...
        public void Explicit_converter_still_wins_over_automatic_Parse()
        {
            ...
            var t = new MoneyMapper().Map(new MoneySource
            {
                Amount = "42"
            });
        ...
        {
            var result = new CharToStringMapper().Map(new CharSrc
            {
                V = 'A'
            });
        ...
        {
            var result = new BoolToStringMapper().Map(new BoolSrc
            {
                V = true
            });
        ...
        public void Bool_to_string_round_trips_via_parse()
        {
            ...
            var trueStr = new BoolToStringMapper().Map(new BoolSrc
            {
                V = true
            }).V;
            var falseStr = new BoolToStringMapper().Map(new BoolSrc
            {
                V = false
            }).V;
        ...
        {
            var result = new StringToDoubleMapper().Map(new StringSrc
            {
                V = "3.14"
            });
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToDoubleMapper().Map(new StringSrc
            {
                V = "abc"
            }));
        }
        ...
        {
            var result = new StringToFloatMapper().Map(new StringSrc
            {
                V = "3.14"
            });
