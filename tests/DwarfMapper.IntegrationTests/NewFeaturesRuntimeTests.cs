...
// ── Phase 2: [MapValue] constant + computed ──────────────────────────────────
    public class Nf_MvSrc
    {
        public int Id { get; set; }
    }

    public class Nf_MvDst
    {
        public int Id { get; set; }
    ...
    [DwarfMapper]
    public partial class Nf_MvMapper
    {
...
// ── Phase 3: deep source path ────────────────────────────────────────────────
    public class Nf_Inner
    {
        public string Name { get; set; } = "";
    }

    public class Nf_DpSrc
    {
        public Nf_Inner Customer { get; set; } = new();
    }

    public class Nf_DpDst
    {
        public string CustomerName { get; set; } = "";
    }

    [DwarfMapper]
    public partial class Nf_DpMapper
    {
...
// ── Phase 4: unflatten ───────────────────────────────────────────────────────
    ...
    public class Nf_UfDst
    {
        public Nf_Addr Address { get; set; } = new();
    }

    [DwarfMapper]
    public partial class Nf_UfMapper
    {
...
// ── Phase 5: additional parameters ───────────────────────────────────────────
    public class Nf_ApSrc
    {
        public int Id { get; set; }
    }

    public class Nf_ApDst
    {
        public int Id { get; set; }
    ...
    [DwarfMapper]
    public partial class Nf_ApMapper
    {
        public partial Nf_ApDst Map(Nf_ApSrc s, string tenant, int version);
    }

// ── Phase 6: NameConvention.Flexible ─────────────────────────────────────────
    public class Nf_NcSrc
    {
    ...
    public partial class Nf_NcMapper
    {
        public partial Nf_NcDst Map(Nf_NcSrc s);
    }

// ── Phase 8: NullSubstitute + When ───────────────────────────────────────────
    public class Nf_NwSrc
    {
        public string? Name { get; set; }
    ...
    [DwarfMapper]
    public partial class Nf_NwMapper
    {
        ...
        private static bool Eligible(Nf_NwSrc s)
        {
            return s.Tier > 0;
        }
    }
...
// ── Phase 7: [ReverseMap] round-trip ─────────────────────────────────────────
    ...
    [DwarfMapper]
    public partial class Nf_RmMapper
    {
        [ReverseMap]
    ...
    public class NewFeaturesRuntimeTests
    {
        ...
        {
            var d = new Nf_MvMapper().Map(new Nf_MvSrc
            {
                Id = 1
            });
            Assert.Equal(1, d.Id);
        ...
        {
            var d = new Nf_DpMapper().Map(new Nf_DpSrc
            {
                Customer = new Nf_Inner
                {
                    Name = "Ann"
                }
            });
        ...
        {
            var d = new Nf_UfMapper().Map(new Nf_UfSrc
            {
                City = "Brno",
                Zip = "60200"
            });
        ...
        {
            var d = new Nf_ApMapper().Map(new Nf_ApSrc
                {
                    Id = 7
                },
                "acme",
        ...
        {
            var d = new Nf_NcMapper().Map(new Nf_NcSrc
            {
                user_name = "ann",
                USER_ID = 42
            });
        ...
        {
            var d = new Nf_NwMapper().Map(new Nf_NwSrc
            {
                Name = null,
                Tier = 1,
                Bonus = 5
        ...
        {
            var eligible = new Nf_NwMapper().Map(new Nf_NwSrc
            {
                Name = "x",
                Tier = 5,
                Bonus = 10
            ...
            var ineligible = new Nf_NwMapper().Map(new Nf_NwSrc
            {
                Name = "x",
                Tier = 0,
                Bonus = 10
