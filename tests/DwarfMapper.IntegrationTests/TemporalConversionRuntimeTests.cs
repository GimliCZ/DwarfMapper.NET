...
// ── Tests ─────────────────────────────────────────────────────────────────────
    ...
    public class TemporalConversionRuntimeTests
    {
        ...
        public void DateTime_to_string_to_DateTime_round_trips_utc_subsecond()
        {
            ...
            var stringDto = new DateTimeToStringMapper().Map(new DateTimeSrc
            {
                V = original
            });
            var restoredDto = new StringToDateTimeMapperT().Map(new StringSrcTemporal
            {
                V = stringDto.V
            });
        ...
        public void DateTime_to_string_utc_produces_Z_suffix()
        {
            ...
            var result = new DateTimeToStringMapper().Map(new DateTimeSrc
            {
                V = dt
            });
        ...
        public void String_to_DateTime_bad_input_throws()
        {
            Assert.ThrowsAny<Exception>(() =>
                new StringToDateTimeMapperT().Map(new StringSrcTemporal
                {
                    V = "not-a-date"
                }));
        }
        ...
        public void DateTimeOffset_to_string_to_DateTimeOffset_round_trips()
        {
            ...
            var stringDto = new DateTimeOffsetToStringMapper().Map(new DateTimeOffsetSrc
            {
                V = original
            });
            var restoredDto = new StringToDateTimeOffsetMapper().Map(new StringSrcTemporal
            {
                V = stringDto.V
            });
        ...
        public void DateTimeOffset_utc_produces_plus_zero_offset()
        {
            ...
            var result = new DateTimeOffsetToStringMapper().Map(new DateTimeOffsetSrc
            {
                V = dto
            });
        ...
        public void TimeSpan_to_string_round_trips()
        {
            ...
            var stringDto = new TimeSpanToStringMapper().Map(new TimeSpanSrc
            {
                V = original
            });
            var restoredDto = new StringToTimeSpanMapperT().Map(new StringSrcTemporal
            {
                V = stringDto.V
            });
            Assert.Equal(original, restoredDto.V);
