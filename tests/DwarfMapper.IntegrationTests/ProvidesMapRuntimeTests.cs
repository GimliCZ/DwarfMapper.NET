...
namespace DwarfMapper.IntegrationTests
{
    ...
    public sealed class ProvidesMapRuntimeTests
    {
        ...
        private static UserQuotesDocument Document()
        {
            return new UserQuotesDocument
            {
                Id = "u1",
                Quotes =
                [
        ...
        public void The_element_map_it_delegates_to_still_works_on_its_own()
        {
            ...
            var mapped = (QuoteData)DwarfMapperRegistry.Map(new QuoteDocument
                {
                    Text = "x"
                },
                typeof(QuoteData));
