...
public class GmOrder { public int Id { get; set; } public string Name { get; set; } = ""; }
public class GmOrderDto { public int Id { get; set; } public string Name { get; set; } = ""; }

public class GmCustomer { public long Num { get; set; } public GmAddr Addr { get; set; } = new(); }
public class GmCustomerDto { public int Num { get; set; } public GmAddrDto Addr { get; set; } = new(); }
public class GmAddr { public string City { get; set; } = ""; }
public class GmAddrDto { public string City { get; set; } = ""; }
...
public class GenerateMapAttributeRuntimeTests
{
    ...
    {
        var m = new GmMappers();
        GmOrderDto o = m.Map(new GmOrder { Id = 1 });
        GmCustomerDto c = m.Map(new GmCustomer { Num = 2 });
        Assert.Equal(1, o.Id);
