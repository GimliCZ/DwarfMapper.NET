...
{
    private static BasicsDto Map(Basics src) => new BasicsMapper().Map(src);
    ...
    {
        // NaN
        var srcNaN = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        // +Infinity
        var srcPosInf = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        // -Infinity
        var srcNegInf = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        // Epsilon
        var srcEps = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        // MinValue / MaxValue
        var srcMM = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
    ...
    {
        // decimal.MinValue
        var src1 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        var src2 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
        ...
        var src3 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            M = preciseDecimal };
        var dto3 = Map(src3);
        Assert.Equal(preciseDecimal, dto3.M);

        // string: empty and unicode
        var src4 = new Basics { G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            Str = "" };
        var dto4 = Map(src4);
        Assert.Equal("", dto4.Str);

        var src5 = new Basics { G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            Str = "Moria äöü世界" };
        var dto5 = Map(src5);
        ...
        var src6 = new Basics { Str = "", Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            G = Guid.Empty };
        var dto6 = Map(src6);
        Assert.Equal(Guid.Empty, dto6.G);

        var src7 = new Basics { Str = "", Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            G = fixedGuid };
        var dto7 = Map(src7);
        Assert.Equal(fixedGuid, dto7.G);

        // DateTime: MinValue, MaxValue, Utc Kind
        var src8 = new Basics { Str = "", G = Guid.Empty, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            Dt = DateTime.MinValue };
        var dto8 = Map(src8);
        Assert.Equal(DateTime.MinValue, dto8.Dt);

        var src9 = new Basics { Str = "", G = Guid.Empty, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            Dt = DateTime.MaxValue };
        var dto9 = Map(src9);
        Assert.Equal(DateTime.MaxValue, dto9.Dt);

        var utcDt = new DateTime(2025, 6, 9, 12, 0, 0, DateTimeKind.Utc);
        var src10 = new Basics { Str = "", G = Guid.Empty, Dto = DateTimeOffset.MinValue, Ts = TimeSpan.Zero,
            Dt = utcDt };
        var dto10 = Map(src10);
        ...
        var src11 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Ts = TimeSpan.Zero,
            Dto = DateTimeOffset.MinValue };
        var dto11 = Map(src11);
        Assert.Equal(DateTimeOffset.MinValue, dto11.Dto);

        var src12 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Ts = TimeSpan.Zero,
        ...
        var src13 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Ts = TimeSpan.Zero,
            Dto = dtWithOffset };
        var dto13 = Map(src13);
        ...
        var src14 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue,
            Ts = TimeSpan.MinValue };
        var dto14 = Map(src14);
        Assert.Equal(TimeSpan.MinValue, dto14.Ts);

        var src15 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue,
            Ts = TimeSpan.MaxValue };
        var dto15 = Map(src15);
        Assert.Equal(TimeSpan.MaxValue, dto15.Ts);

        var src16 = new Basics { Str = "", G = Guid.Empty, Dt = DateTime.MinValue, Dto = DateTimeOffset.MinValue,
            Ts = TimeSpan.Zero };
        var dto16 = Map(src16);
