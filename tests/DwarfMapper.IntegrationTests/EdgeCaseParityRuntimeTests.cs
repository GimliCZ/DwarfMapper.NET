...
// ── Large collection ─────────────────────────────────────────────────────────
    ...
    public class EdgeCaseParityRuntimeTests
    {
        ...
        {
            var src = new Ec_NestSrc
            {
                Inner = new Ec_LongHolder
                {
                    V = (long)int.MaxValue + 5
                }
            };
        ...
        {
            var src = new Ec_CtorSrc
            {
                V = (long)int.MaxValue + 1
            };
        ...
        {
            var src = new Ec_DictLongSrc
            {
                M = new Dictionary<string, long>
                {
        ...
        {
            var d = new Ec_BoundMapper().Map(new Ec_BoundSrc
            {
                I = int.MaxValue,
                B = byte.MaxValue,
                N = 100
            ...
            var min = new Ec_BoundMapper().Map(new Ec_BoundSrc
            {
                I = int.MinValue,
                B = 0,
                N = int.MinValue
        ...
        public void Additional_parameter_with_conversion_applies_at_runtime()
        {
            ...
            var d = new Ec_ApcMapper().Map(new Ec_ApcSrc
                {
                    Id = 1
                },
                42L);
            ...
            Assert.Throws<OverflowException>(() =>
                new Ec_ApcMapper().Map(new Ec_ApcSrc
                    {
                        Id = 1
                    },
                    (long)int.MaxValue + 1));
        ...
        {
            Assert.Throws<InvalidOperationException>(() => new Ec_NvThrowMapper().Map(new Ec_NvSrc
            {
                V = null
            }));
            Assert.Equal(7,
                new Ec_NvThrowMapper().Map(new Ec_NvSrc
                {
                    V = 7
                }).V);
        }
        ...
        {
            Assert.Equal(0,
                new Ec_NvDefaultMapper().Map(new Ec_NvSrc
                {
                    V = null
                }).V);
            Assert.Equal(7,
        ...
        {
            Assert.Null(new Ec_NnMapper().Map(new Ec_NvSrc
            {
                V = null
            }).V);
            Assert.Equal(7,
                new Ec_NnMapper().Map(new Ec_NvSrc
                {
                    V = 7
                }).V);
        }
        ...
        {
            var src = new Ec_BigSrc
            {
                V = Enumerable.Range(0, 10_000).ToList()
            };
