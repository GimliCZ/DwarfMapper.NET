...
namespace DwarfMapper.IntegrationTests
{
    ...
    {
        public SrcColor Color { get; set; }

        public SrcColor Code { get; set; }

        public string Name { get; set; } = "";
    }

    public class EnumDst
    {
        public DstColor Color { get; set; }

        public int Code { get; set; }

        public DstColor Name { get; set; }
    }
    ...
    public class EnumRuntimeTests
    {
        ...
        {
            var d = new EnumMapper().Map(new EnumSrc
            {
                Color = SrcColor.Green,
                Code = SrcColor.Blue,
                Name = "Red"
            });
