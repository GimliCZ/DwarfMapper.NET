...
// ── Tests ─────────────────────────────────────────────────────────────────────
    ...
    public class ConversionDefensiveRuntimeTests
    {
        ...
        {
            Assert.Equal((short)32000,
                new LongToShortMapper().Map(new LongSrcD
                {
                    V = 32000L
                }).V);
        }
        ...
        {
            Assert.Equal((byte)200,
                new LongToByteMapper().Map(new LongSrcD
                {
                    V = 200L
                }).V);
        }
        ...
        {
            Assert.Throws<OverflowException>(() => new LongToByteMapper().Map(new LongSrcD
            {
                V = -1L
            }));
        }
        ...
        public void Int_to_byte_in_range_preserves_value()
        {
            Assert.Equal((byte)42,
                new IntToByteMapper().Map(new IntSrcD
                {
                    V = 42
                }).V);
        }
        ...
        {
            Assert.Throws<OverflowException>(() => new IntToByteMapper().Map(new IntSrcD
            {
                V = byte.MaxValue + 1
            }));
        }
        ...
        {
            Assert.Equal((sbyte)100,
                new IntToSByteMapper().Map(new IntSrcD
                {
                    V = 100
                }).V);
        }
        ...
        {
            Assert.Throws<OverflowException>(() => new IntToSByteMapper().Map(new IntSrcD
            {
                V = sbyte.MaxValue + 1
            }));
        }
        ...
        {
            Assert.Equal(12345,
                new UIntToIntMapper().Map(new UIntSrcD
                {
                    V = 12345u
                }).V);
        }
        ...
        {
            Assert.Throws<OverflowException>(() => new UIntToIntMapper().Map(new UIntSrcD
            {
                V = int.MaxValue + 1u
            }));
        }
        ...
        {
            Assert.Equal(9876543210UL,
                new LongToULongMapper().Map(new LongSrcD2
                {
                    V = 9876543210L
                }).V);
        }
        ...
        public void Long_to_ulong_negative_throws_OverflowException()
        {
            ...
            Assert.Throws<OverflowException>(() => new LongToULongMapper().Map(new LongSrcD2
            {
                V = -1L
            }));
        }
        ...
        public void Int_to_uint_negative_one_does_NOT_wrap_to_UInt32Max()
        {
            ...
            Assert.Throws<OverflowException>(() => new IntToUIntMapper().Map(new IntSrc
            {
                V = -1
            }));
        }
        ...
        {
            Assert.Equal(100u,
                new ULongToUIntMapper().Map(new ULongSrcD
                {
                    V = 100UL
                }).V);
        }
        ...
        {
            Assert.Equal((byte)100,
                new ShortToByteMapper().Map(new ShortSrcD
                {
                    V = 100
                }).V);
        }
        ...
        {
            Assert.Throws<OverflowException>(() => new ShortToByteMapper().Map(new ShortSrcD
            {
                V = -1
            }));
        }
        ...
        public void Nullable_int_to_short_in_range_preserves_value()
        {
            Assert.Equal((short)100,
                new NullableIntToShortMapperD().Map(new NullableIntSrcD
                {
                    V = 100
                }).V);
        }
        ...
        public void Nullable_int_to_short_null_with_set_default_gives_zero()
        {
            Assert.Equal((short)0,
                new NullableIntToShortSetDefaultMapper().Map(new NullableIntSrcD
                {
                    V = null
                }).V);
        }
        ...
        {
            Assert.Equal(42,
                new NullableLongToIntMapper().Map(new NullableLongSrcD
                {
                    V = 42L
                }).V);
        }
        ...
        {
            var result = new ListLongToIntMapper().Map(new ListLongSrc
            {
                Items = new List<long>
                {
                    1L,
        ...
        {
            Assert.Throws<OverflowException>(() =>
                new ListLongToIntMapper().Map(new ListLongSrc
                {
                    Items = new List<long>
                    {
                        1L,
        ...
        {
            var result = new ArrayLongToIntMapper().Map(new ArrayLongSrc
            {
                Items = new[]
                {
                    5L, -3L, 100L
        ...
        {
            Assert.Throws<OverflowException>(() =>
                new ArrayLongToIntMapper().Map(new ArrayLongSrc
                {
                    Items = new[]
                    {
                        int.MaxValue + 1L
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToIntMapper2().Map(new StringSrc
            {
                V = ""
            }));
        }
        ...
        {
            Assert.Throws<FormatException>(() => new StringToIntMapper2().Map(new StringSrc
            {
                V = "not-a-number"
            }));
        }
        ...
        {
            Assert.Throws<OverflowException>(() =>
                new StringToIntMapper2().Map(new StringSrc
                {
        ...
        {
            Assert.True(new StringToBoolMapper().Map(new StringSrc
            {
                V = "True"
            }).V);
        }
        ...
        {
            Assert.False(new StringToBoolMapper().Map(new StringSrc
            {
                V = "False"
            }).V);
        }
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToBoolMapper().Map(new StringSrc
            {
                V = "yes"
            }));
        }
        ...
        public void String_to_Guid_valid_round_trips()
        {
            ...
            Assert.Equal(g,
                new StringToGuidMapper().Map(new StringSrc
                {
                    V = g.ToString()
                }).V);
        }
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToGuidMapper().Map(new StringSrc
            {
                V = "not-a-guid"
            }));
        }
        ...
        {
            var result = new StringToDecimalMapper().Map(new StringSrcE
            {
                V = "123.456"
            });
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToDecimalMapper().Map(new StringSrcE
            {
                V = "abc"
            }));
        }
        ...
        public void String_to_TimeSpan_known_value_round_trips()
        {
            ...
            var result = new StringToTimeSpanMapper().Map(new StringSrcE
            {
                V = ts.ToString()
            });
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToTimeSpanMapper().Map(new StringSrcE
            {
                V = "not-a-timespan"
            }));
        }
        ...
        public void String_to_DateTime_ISO_round_trips()
        {
            ...
            var result = new StringToDateTimeMapper().Map(new StringSrcE
            {
                V = s
            });
        ...
        {
            Assert.ThrowsAny<Exception>(() => new StringToDateTimeMapper().Map(new StringSrcE
            {
                V = "not-a-date"
            }));
        }
        ...
        {
            var dto = new IntToStringMapper().Map(new IntSrc3
            {
                V = -99999
            });
        ...
        public void Decimal_to_string_round_trips_via_invariant_culture()
        {
            ...
            var dto = new DecimalToStringMapper().Map(new DecimalSrcE
            {
                V = 123.456m
            });
        ...
        public void Guid_to_string_then_parse_back_round_trips()
        {
            ...
            var dto = new GuidToStringMapper().Map(new GuidSrc
            {
                V = g
            });
        ...
        public void Decimal_string_conversion_under_de_DE_culture_uses_invariant()
        {
            ...
            try
            {
                ...
                var strDto = new DecimalToStringMapper().Map(new DecimalSrcE
                {
                    V = 123.456m
                });
                ...
                var decDto = new StringToDecimalMapper().Map(new StringSrcE
                {
                    V = "123.456"
                });
        ...
        public void Int_string_conversion_under_non_invariant_culture_is_stable()
        {
            ...
            try
            {
                ...
                var strDto = new IntToStringMapper().Map(new IntSrc3
                {
                    V = 12345
                });
        ...
        public void Explicit_Use_method_wins_over_automatic_Parse_doubles_value()
        {
            ...
            var result = new UseMethodOverrideMapper().Map(new StringSrcWithUse
            {
                Amount = "42"
            });
        ...
        {
            var result = new LongToNullableIntMapper().Map(new LongSrcD
            {
                V = 42L
            });
        ...
        public void Long_to_nullable_int_overflow_throws()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                new LongToNullableIntMapper().Map(new LongSrcD
                {
                    V = int.MaxValue + 1L
                }));
        }
        ...
        {
            var result = new StringToNullableIntMapper().Map(new StringSrcE
            {
                V = "99"
            });
        ...
        public void String_to_nullable_int_bad_input_throws()
        {
            Assert.ThrowsAny<Exception>(() =>
                new StringToNullableIntMapper().Map(new StringSrcE
                {
                    V = "not-a-number"
                }));
        }
        ...
        {
            var result = new IntToNullableColorMapper().Map(new IntSrcD
            {
                V = 1
            });
        ...
        public void Int_to_nullable_byte_enum_overflow_throws()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                new IntToNullableEByteMapper().Map(new IntSrcD
                {
                    V = 300
                }));
        }
        ...
        {
            var result = new IntToNullableEByteMapper().Map(new IntSrcD
            {
                V = 200
            });
        ...
        {
            var result =
                new ListStringToIntMapper().Map(new ListStringSrc
                {
        ...
        {
            var result = new LongToNintMapper().Map(new LongSrcD
            {
                V = 42L
            });
            Assert.Equal(42, result.V);
        ...
        public void Long_to_nint_overflow_throws()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                new LongToNintMapper().Map(new LongSrcD
                {
                    V = int.MaxValue + 1L
                }));
        }
        ...
        {
            var result = new NintToIntMapper().Map(new NintSrc
            {
                V = 100
            });
        ...
        public void Nint_to_int_overflow_throws_on_64bit()
        {
            ...
            Assert.Throws<OverflowException>(() =>
                new NintToIntMapper().Map(new NintSrc
                {
                    V = overflowVal
                }));
        }
