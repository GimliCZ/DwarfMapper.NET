...
{
    public class NafInnerSrc
    {
        public int Val { get; set; }
    }

    public class NafInnerDst
    {
        public int Val { get; set; }
    ...
    public class NafOuterSrc
    {
        public NafInnerSrc Child { get; set; } = new();
    }

    public class NafOuterDst
    {
        public NafInnerDst Child { get; set; } = new();
    }
...
// a nested member silently loses the post-processing.
    ...
    {
        [AfterMap]
        private static void Build(NafInnerSrc s, NafInnerDst d)
        {
            d.Computed = s.Val * 10;
        }
    }
    ...
    public class NestedAfterMapRuntimeTests
    {
        ...
        {
            var d = new NestedAfterMapMapper().Map(new NafInnerSrc
            {
                Val = 5
            });
        ...
        {
            var d = new NestedAfterMapMapper().Map(new NafOuterSrc
            {
                Child = new NafInnerSrc
                {
                    Val = 5
                }
            });
