...
// ── Tests ─────────────────────────────────────────────────────────────────────
    ...
    public class NullableToNullableRuntimeTests
    {
        ...
        public void NullableLong_to_NullableInt_null_maps_to_null()
        {
            ...
            var result = new LongNullableToIntNullableMapper().Map(new LongNullableSrc
            {
                V = null
            });
        ...
        public void NullableLong_to_NullableInt_overflow_throws()
        {
            ...
            Assert.Throws<OverflowException>(() => mapper.Map(new LongNullableSrc
            {
                V = int.MaxValue + 1L
            }));
        }
        ...
        {
            var result = new NullableEnumToNullableEnumMapper().Map(new NNE1NullableSrc
            {
                V = null
            });
            Assert.Null(result.V);
