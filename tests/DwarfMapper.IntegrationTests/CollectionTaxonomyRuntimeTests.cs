...
// ─── Interface targets → concrete ────────────────────────────────────────────
    ...
    public class InterfaceCollectionRuntimeTests
    {
        ...
        private readonly TaxInterfaceSrc _src = new()
        {
            Nums = new List<int>
            {
                1,
        ...
        public void IReadOnlySet_roundtrips()
        {
            Assert.Equal(new HashSet<int>
                ...
                _m.ToIReadOnlySet(_src).Nums);
        }

        [Fact]
        public void IList_null_source_yields_empty()
        {
            var r = _m.ToIList(new TaxInterfaceSrc
            {
                Nums = null!
            });
...
// ─── Immutable collection targets ────────────────────────────────────────────
    ...
    public class ImmutableCollectionRuntimeTests
    {
        ...
        private readonly TaxImmutableSrc _src = new()
        {
            Nums = new List<int>
            {
                10,
        ...
        public void ImmutableHashSet_roundtrips()
        {
            ...
            Assert.True(r.Nums.SetEquals(new[]
            {
                10, 20, 30
            }));
        }
        ...
        {
            var r = _m.ToImmutableArray(new TaxImmutableSrc
            {
                Nums = null!
            });
...
// ─── Dictionary interface / immutable dict targets ───────────────────────────
    ...
    public class DictionaryTaxonomyRuntimeTests
    {
        ...
        private readonly TaxDictSrc _src = new()
        {
        ...
        {
            var r = _m.ToIDictionary(new TaxDictSrc
            {
                D = null!
            });
            Assert.NotNull(r.D);
...
// ─── Lazy IEnumerable<T> target — runtime verify ─────────────────────────────
    ...
    public class LazyIEnumerableRuntimeTests
    {
        ...
        {
            var src = new TaxLazyEnumLongSrc
            {
                Nums = new List<int>
                {
                    1,
        ...
        {
            var dst = _m.ToLazyEnum(new TaxLazyEnumSrc
            {
                Nums = null!
            });
...
// ─── NullCollections = AsNull ─────────────────────────────────────────────────
    ...
    public class NullCollectionsRuntimeTests
    {
        ...
        {
            var dst = new TaxNullAsNullMapper().Map(new TaxNullAsSrc
            {
                Nums = null
            });
        ...
        {
            var dst = new TaxNullAsEmptyMapper().Map(new TaxNullAsEmptySrc
            {
                Nums = null
            });
            Assert.NotNull(dst.Nums);
...
// ─── Nested collections round-trips ──────────────────────────────────────────
    ...
    public class NestedCollectionRuntimeTests
    {
        ...
        public void Dictionary_with_list_value_roundtrips()
        {
            var src = new TaxNestedSrc
            {
                DictOfList = new Dictionary<string, List<int>>
                {
                    ["k"] = new()
                    {
                        9,
...
// ─── Cross-type conversions: List<long>→ImmutableArray<int>, Dict→ImmutableDict ─
    ...
    public class CrossTypeConversionRuntimeTests
    {
        ...
        {
            var src = new TaxConvSrc
            {
                LongNums = new List<long>
                {
                    1L,
                    2L,
                    3L
