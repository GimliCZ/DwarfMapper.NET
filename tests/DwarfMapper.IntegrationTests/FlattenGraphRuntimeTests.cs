...
// IReadOnlyList target model
    ...
    public class FlattenGraphRuntimeTests
    {
        ...
        public void Diamond_shared_node_collected_once()
        {
            ...
            var right = new FGNode
            {
                Name = "R",
                X = shared
            };
            var entry = new FGNode
            {
                Name = "E",
                X = left,
                Y = right
        ...
        {
            var c1 = new FGCollNode
            {
                Name = "C1"
            };
            var c2 = new FGCollNode
            {
                Name = "C2"
            };
