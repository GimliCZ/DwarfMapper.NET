    ...
    public sealed class CollectionShapeRegistrationTests
    {
        ...
        public void RegisterCollectionShapes_false_registers_the_element_map_only()
        {
            ...
            Assert.False(DwarfMapperRegistry.IsProvided(
                typeof(IEnumerable<OptedOutSrc>),
                typeof(List<OptedOutDst>)));

            Assert.Throws<DwarfMapMissingException>(() => DwarfMapperRegistry.Map(new List<OptedOutSrc>(), typeof(List<OptedOutDst>)));
        }
        ...
        public void The_element_map_itself_is_unaffected()
        {
            ...
            var mapped = (ShapeDst)DwarfMapperRegistry.Map(new ShapeSrc
                {
                    Id = 5,
                    Name = "x"
                },
