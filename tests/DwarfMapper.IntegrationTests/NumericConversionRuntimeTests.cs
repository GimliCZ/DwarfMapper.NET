...
// ── Tests ─────────────────────────────────────────────────────────────────────
    ...
    public class NumericConversionRuntimeTests
    {
        ...
        {
            var result = new LongToIntMapper().Map(new LongSrc
            {
                V = 42L
            });
        ...
        public void Long_to_int_out_of_range_throws_OverflowException()
        {
            ...
            Assert.Throws<OverflowException>(() => mapper.Map(new LongSrc
            {
                V = int.MaxValue + 1L
            }));
        }
        ...
        {
            var result = new IntToUIntMapper().Map(new IntSrc
            {
                V = 100
            });
        ...
        public void Int_to_uint_negative_throws_OverflowException()
        {
            ...
            Assert.Throws<OverflowException>(() => mapper.Map(new IntSrc
            {
                V = -1
            }));
        }
        ...
        {
            var result = new IntToShortMapper().Map(new IntSrc2
            {
                V = 1000
            });
        ...
        public void Int_to_short_out_of_range_throws_OverflowException()
        {
            ...
            Assert.Throws<OverflowException>(() => mapper.Map(new IntSrc2
            {
                V = short.MaxValue + 1
            }));
        }
        ...
        {
            var result = new ULongToLongMapper().Map(new ULongSrc
            {
                V = 9876543210UL
            });
        ...
        public void Ulong_to_long_out_of_range_throws_OverflowException()
        {
            ...
            Assert.Throws<OverflowException>(() => mapper.Map(new ULongSrc
            {
                V = long.MaxValue + 1UL
            }));
        }
        ...
        {
            var result = new NullableIntToShortMapper().Map(new NullableIntSrc
            {
                V = 42
            });
        ...
        public void Nullable_int_to_short_null_throws_by_default()
        {
            ...
            Assert.Throws<InvalidOperationException>(() => mapper.Map(new NullableIntSrc
            {
                V = null
            }));
        }
        ...
        {
            var mapper = new NullableIntToShortMapper();
            Assert.Throws<OverflowException>(() => mapper.Map(new NullableIntSrc
            {
                V = short.MaxValue + 1
            }));
        }
