...
namespace DwarfMapper.IntegrationTests
{
    ...
    public class AsyncSpanQueryablePropertyTests
    {
        ...
        {
            return Enumerable.Range(0, 30).Select(i => new object[]
            {
                i
            });
        }
