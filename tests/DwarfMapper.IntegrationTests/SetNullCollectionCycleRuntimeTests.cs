...
// Cross-collection cycle via dictionary value.
    ...
    public class SetNullCollectionCycleRuntimeTests
    {
        ...
        {
            var root = new SncTree
            {
                V = 1,
                Children = new List<SncTree>()
            };
            var child = new SncTree
            {
                V = 2,
                Children = new List<SncTree>()
            };
        ...
        {
            var a = new SncDictNode
            {
                V = 1,
                Edges = new Dictionary<string, SncDictNode>()
            };
            var b = new SncDictNode
            {
                V = 2,
                Edges = new Dictionary<string, SncDictNode>()
            };
