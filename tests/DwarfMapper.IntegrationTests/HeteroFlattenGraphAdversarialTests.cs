...
namespace DwarfMapper.IntegrationTests
{
    ...
    public class HeteroFlattenGraphGoldenFixtureTests
    {
        ...
        {
            var leaves = Enumerable.Range(0, 6).Select(i => new H4Leaf
            {
                Name = $"L{i}",
                Data = i * 10
            }).ToArray();
            ...
            Assert.Equal(new[]
                ...
                leafDtos.Select(l => l.Data).ToArray());
        ...
        public void FourArm_hierarchy_all_levels_dispatch_correctly()
        {
            ...
            Assert.IsType<DrvLevel3Dto>(m.Map(new DrvLevel3
            {
                Id = "a",
                L1 = 1,
                L2 = 2,
            ...
            Assert.IsType<DrvLevel2Dto>(m.Map(new DrvLevel2
            {
                Id = "b",
                L1 = 4,
                L2 = 5
            }));
            Assert.IsType<DrvLevel1Dto>(m.Map(new DrvLevel1
            {
                Id = "c",
                L1 = 6
            }));
