...
// Verified here for both a plain struct and a readonly record struct node.
    ...
    {
        public PsShared Ref { get; set; }
    }

    public sealed class PsRoot
    {
        public PsHolder H1 { get; set; }

        public PsHolder H2 { get; set; }
    }

    public sealed class PsSharedDto
    {
        public int V { get; set; }
    }

    public struct PsHolderDto
    {
        public PsSharedDto Ref { get; set; }
    }

    public sealed class PsRootDto
    {
        public PsHolderDto H1 { get; set; }

        public PsHolderDto H2 { get; set; }
    }

    public sealed class RsShared
    {
        public int V { get; set; }
    }
    ...
    public sealed class RsRoot
    {
        public RsHolder H1 { get; set; }

        public RsHolder H2 { get; set; }
    }

    public sealed class RsSharedDto
    {
        public int V { get; set; }
    }
    ...
    public sealed class RsRootDto
    {
        public RsHolderDto H1 { get; set; }

        public RsHolderDto H2 { get; set; }
    }
    ...
    public class PreserveThroughStructRuntimeTests
    {
        ...
        {
            var shared = new RsShared
            {
                V = 7
            };
            var root = new RsRoot
            {
                H1 = new RsHolder(shared),
                H2 = new RsHolder(shared)
            };
