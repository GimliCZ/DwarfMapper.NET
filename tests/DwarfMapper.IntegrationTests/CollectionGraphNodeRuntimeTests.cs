...
// ─── Tests ───────────────────────────────────────────────────────────────────
    ...
    public class CollectionGraphNodeRuntimeTests
    {
        ...
        public void Shared_list_produces_same_target_list_instance_under_Preserve()
        {
            ...
            var a = new CgnListOwnerSrc
            {
                Tag = "A",
                Nums = shared
            };
            var b = new CgnListOwnerSrc
            {
                Tag = "B",
                Nums = shared
            };
        ...
        public void Shared_dictionary_produces_same_target_dict_instance_under_Preserve()
        {
            ...
            var a = new CgnDictOwnerSrc
            {
                Tag = "A",
                Data = shared
            };
            var b = new CgnDictOwnerSrc
            {
                Tag = "B",
                Data = shared
            };
        ...
        {
            var sharedChild = new CgnChildSrc
            {
                Name = "shared"
            };
            var a = new CgnParentSrc
            {
                Tag = "A",
                Kids = new List<CgnChildSrc>
                {
                    sharedChild
                }
            };
            var b = new CgnParentSrc
            {
                Tag = "B",
                Kids = new List<CgnChildSrc>
                {
...
// Default ReferenceHandling = None — no DwarfRefContext, no graph tracking.
    ...
    public class NoneModeCollectionRegressionTests
    {
        ...
        public void None_mode_shared_list_produces_two_independent_copies()
        {
            ...
            var src1 = new NoneListOwnerSrc
            {
                Tag = "A",
                Nums = shared
            };
            var src2 = new NoneListOwnerSrc
            {
                Tag = "B",
                Nums = shared
            };
