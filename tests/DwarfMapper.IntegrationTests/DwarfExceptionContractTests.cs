...
public sealed class ExcPlainSrc { public int X { get; set; } }
public sealed class ExcPlainDst { public int X { get; set; } }
...
public sealed class DwarfExceptionContractTests
{
    ...
    {
        var ex = new DwarfMapMissingException(typeof(ExcPlainSrc), typeof(ExcPlainDst), null, isUpdate: true);
