...
// this file covers runtime behaviour. File-scoped domain types use a `Par_` prefix to stay unique.
    ...
    public class LibraryParityRuntimeTests
    {
        ...
        {
            Assert.Equal("Ada",
                new Par_RenameMapper().Map(new Par_Src
                {
                    Id = 1,
                    FullName = "Ada"
                }).Name);
        ...
        {
            Assert.Equal("",
                new Par_IgnoreMapper().Map(new Par_IgnSrc
                {
                    Id = 1
                }).Computed);
        }
        ...
        {
            var d = new Par_ConstMapper().Map(new Par_ConstSrc
            {
                Id = 1
            });
        ...
        {
            Assert.Equal("$1.50",
                new Par_ConverterMapper().Map(new Par_ConvSrc
                {
                    Cents = 150
                }).Price);
        }
        ...
        {
            Assert.Equal("(none)",
                new Par_NullSubMapper().Map(new Par_NullSubSrc
                {
                    Name = null
                }).Name);
            Assert.Equal("Ada",
        ...
        {
            Assert.Equal(21,
                new Par_WhenMapper().Map(new Par_WhenSrc
                {
                    Age = 21
                }).Age);
            Assert.Equal(0,
        ...
        {
            Assert.Equal("Brno",
                new Par_FlattenMapper().Map(new Par_FlatSrc
                {
                    Address = new Par_Addr
                    {
                        City = "Brno"
                    }
                }).City);
        ...
        {
            Assert.Equal("Ada",
                new Par_DeepPathMapper().Map(new Par_PathSrc
                {
                    Customer = new Par_Cust
                    {
                        Name = "Ada"
                    }
                }).CustomerName);
        ...
        {
            Assert.Equal("Brno",
                new Par_UnflattenMapper().Map(new Par_UnflatSrc
                {
                    City = "Brno"
                }).Address.City);
        }
        ...
        {
            var d = new Par_CtorParamMapper().Map(new Par_CtorSrc
            {
                Id = 7,
                Label = "Boss"
            });
        ...
        public void Reverse_map_parity()
        {
            ...
            var dto = m.ToDto(new Par_RevEntity
            {
                Id = 1,
                FullName = "Ada"
            });
        ...
        {
            Assert.Equal(Par_E2.Green,
                new Par_EnumByNameMapper().Map(new Par_EnumSrc
                {
                    Color = Par_E1.Green
                }).Color);
        }
        ...
        {
            Assert.Equal(Par_E2.Blue,
                new Par_EnumByValueMapper().Map(new Par_EnumSrc
                {
                    Color = Par_E1.Red
                }).Color);
        }
        ...
        {
            var d = new Par_NullCollEmptyMapper().Map(new Par_NullCollSrc
            {
                Items = null
            });
        ...
        {
            Assert.Null(new Par_NullCollNullMapper().Map(new Par_NullCollSrc
            {
                Items = null
            }).Items);
        }
        ...
        {
            var shared = new Par_Node
            {
                V = 42
            };
            var p = new Par_Parent
            {
                Left = shared,
                Right = shared
            };
        ...
        {
            var dest = new Par_UpdDst
            {
                Id = 0,
                Name = "old"
            };
            var result = new Par_UpdateMapper().Update(new Par_UpdSrc
                {
                    Id = 5,
                    Name = "new"
                },
        ...
        {
            Assert.Equal("acme",
                new Par_ExtraParamMapper().Map(new Par_ApSrc
                    {
                        Id = 1
                    },
                    "acme").Tenant);
        ...
        {
            var d = new Par_FlexibleMapper().Map(new Par_SnakeSrc
            {
                user_id = 7,
                user_name = "ada"
            });
        ...
        {
            var d = new Par_CaseInsensitiveMapper().Map(new Par_CiSrc
            {
                id = 7,
                name = "ada"
            });
        ...
        {
            Assert.Equal("src#3",
                new Par_HookMapper().Map(new Par_HookSrc
                {
                    Id = 3
                }).Audit);
        }
        ...
        {
            var d = new Par_ScalarMapper().Map(new Par_ScalarSrc
            {
                Count = 100,
                Amount = "42"
            });
        ...
        {
            var d = new Par_UserMethodMapper().Map(new Par_UmSrc
            {
                Amount = new Par_Money
                {
                    V = 5
                }
            });
