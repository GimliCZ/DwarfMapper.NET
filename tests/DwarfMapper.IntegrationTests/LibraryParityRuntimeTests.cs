...
#region domain types
public class Par_Src { public int Id { get; set; } public string FullName { get; set; } = ""; }
public class Par_Dst { public int Id { get; set; } public string Name { get; set; } = ""; }
[DwarfMapper] public partial class Par_RenameMapper
{
    [MapProperty(nameof(Par_Src.FullName), nameof(Par_Dst.Name))]
    public partial Par_Dst Map(Par_Src s);
}

public class Par_IgnSrc { public int Id { get; set; } }
public class Par_IgnDst { public int Id { get; set; } public string Computed { get; set; } = ""; }
[DwarfMapper] public partial class Par_IgnoreMapper
{
    [MapIgnore(nameof(Par_IgnDst.Computed))]
    public partial Par_IgnDst Map(Par_IgnSrc s);
}

public class Par_ConstSrc { public int Id { get; set; } }
public class Par_ConstDst { public int Id { get; set; } public string Source { get; set; } = ""; public int Stamp { get; set; } }
[DwarfMapper] public partial class Par_ConstMapper
{
    ...
    private static int FixedStamp() => 1234;
}

public class Par_ConvSrc { public int Cents { get; set; } }
public class Par_ConvDst { public string Price { get; set; } = ""; }
[DwarfMapper] public partial class Par_ConverterMapper
{
...
public class Par_NullSubSrc { public string? Name { get; set; } }
public class Par_NullSubDst { public string Name { get; set; } = ""; }
[DwarfMapper] public partial class Par_NullSubMapper
{
...
public class Par_WhenSrc { public int Age { get; set; } }
public class Par_WhenDst { public int Age { get; set; } }
[DwarfMapper] public partial class Par_WhenMapper
{
    ...
    private static bool IsAdult(Par_WhenSrc s) => s.Age >= 18;
}

public class Par_Addr { public string City { get; set; } = ""; }
public class Par_FlatSrc { public int Id { get; set; } public Par_Addr Address { get; set; } = new(); }
public class Par_FlatDst { public int Id { get; set; } public string City { get; set; } = ""; }
[DwarfMapper] public partial class Par_FlattenMapper
{
    [Flatten(nameof(Par_FlatSrc.Address))]
    public partial Par_FlatDst Map(Par_FlatSrc s);
}

public class Par_Cust { public string Name { get; set; } = ""; }
public class Par_PathSrc { public int Id { get; set; } public Par_Cust Customer { get; set; } = new(); }
public class Par_PathDst { public int Id { get; set; } public string CustomerName { get; set; } = ""; }
[DwarfMapper] public partial class Par_DeepPathMapper
{
    [MapProperty("Customer.Name", nameof(Par_PathDst.CustomerName))]
    public partial Par_PathDst Map(Par_PathSrc s);
}

public class Par_UnflatSrc { public int Id { get; set; } public string City { get; set; } = ""; }
public class Par_UnflatDst { public int Id { get; set; } public Par_Addr Address { get; set; } = new(); }
[DwarfMapper] public partial class Par_UnflattenMapper
{
    [MapProperty(nameof(Par_UnflatSrc.City), "Address.City")]
    public partial Par_UnflatDst Map(Par_UnflatSrc s);
}

public class Par_CtorSrc { public int Id { get; set; } public string Label { get; set; } = ""; }
public record Par_CtorDst(int Id, string Title);
[DwarfMapper] public partial class Par_CtorParamMapper
{
    [MapProperty(nameof(Par_CtorSrc.Label), "Title")] // AutoMapper ForCtorParam
    public partial Par_CtorDst Map(Par_CtorSrc s);
}

public class Par_RevEntity { public int Id { get; set; } public string FullName { get; set; } = ""; }
public class Par_RevDto { public int Id { get; set; } public string Name { get; set; } = ""; }
[DwarfMapper] public partial class Par_ReverseMapper
{
    [ReverseMap]
...
public class Par_Animal { public string Name { get; set; } = ""; }
public class Par_Cat : Par_Animal { public int Lives { get; set; } }
public class Par_AnimalDto { public string Name { get; set; } = ""; }
public class Par_CatDto : Par_AnimalDto { public int Lives { get; set; } }
[DwarfMapper] public partial class Par_DerivedMapper
{
    [MapDerivedType<Par_Cat, Par_CatDto>]
    public partial Par_AnimalDto Map(Par_Animal a);
}

public enum Par_E1 { Red, Green, Blue }
public enum Par_E2 { Blue, Green, Red } // different ordinals on purpose
public class Par_EnumSrc { public Par_E1 Color { get; set; } }
public class Par_EnumDst { public Par_E2 Color { get; set; } }
[DwarfMapper] public partial class Par_EnumByNameMapper            // DwarfMapper / Mapperly default: by name
{ public partial Par_EnumDst Map(Par_EnumSrc s); }
[DwarfMapper(EnumStrategy = EnumStrategy.ByValue)] public partial class Par_EnumByValueMapper // AutoMapper/Mapster default
{ public partial Par_EnumDst Map(Par_EnumSrc s); }

public class Par_NullCollSrc { public List<int>? Items { get; set; } }
public class Par_NullCollEmptyDst { public List<int> Items { get; set; } = new(); }   // non-nullable dest → AsEmpty
public class Par_NullCollNullDst { public List<int>? Items { get; set; } }            // nullable dest → AsNull can propagate
[DwarfMapper] public partial class Par_NullCollEmptyMapper        // AutoMapper default AllowNullCollections=false
{ public partial Par_NullCollEmptyDst Map(Par_NullCollSrc s); }
[DwarfMapper(NullCollections = NullCollectionStrategy.AsNull)] public partial class Par_NullCollNullMapper // AllowNullCollections=true
{ public partial Par_NullCollNullDst Map(Par_NullCollSrc s); }

public class Par_Node { public int V { get; set; } public Par_Node? Next { get; set; } }
public class Par_NodeDto { public int V { get; set; } public Par_NodeDto? Next { get; set; } }
[DwarfMapper(MaxDepth = 32)] public partial class Par_DepthMapper // AutoMapper/Mapster MaxDepth
{ public partial Par_NodeDto Map(Par_Node n); }
[DwarfMapper(ReferenceHandling = ReferenceHandlingStrategy.Preserve)] public partial class Par_PreserveMapper // PreserveReferences
{ public partial Par_NodeDto Map(Par_Node n); }
[DwarfMapper(OnCycle = OnCycleStrategy.SetNull)] public partial class Par_SetNullMapper // System.Text.Json IgnoreCycles
{ public partial Par_NodeDto Map(Par_Node n); }

public class Par_Parent { public Par_Node Left { get; set; } = new(); public Par_Node Right { get; set; } = new(); }
public class Par_ParentDto { public Par_NodeDto Left { get; set; } = new(); public Par_NodeDto Right { get; set; } = new(); }
[DwarfMapper(ReferenceHandling = ReferenceHandlingStrategy.Preserve)] public partial class Par_SharedMapper
{ public partial Par_ParentDto Map(Par_Parent p); }

public class Par_UpdSrc { public int Id { get; set; } public string Name { get; set; } = ""; }
public class Par_UpdDst { public int Id { get; set; } public string Name { get; set; } = ""; }
[DwarfMapper] public partial class Par_UpdateMapper             // AutoMapper Map(s,d) / Mapster Adapt(s,d) / Mapperly existing target
{ public partial Par_UpdDst Update(Par_UpdSrc s, Par_UpdDst d); }

public class Par_ApSrc { public int Id { get; set; } }
public class Par_ApDst { public int Id { get; set; } public string Tenant { get; set; } = ""; }
[DwarfMapper] public partial class Par_ExtraParamMapper        // AutoMapper context.Items, by typed param
{ public partial Par_ApDst Map(Par_ApSrc s, string tenant); }

public class Par_SnakeSrc { public int user_id { get; set; } public string user_name { get; set; } = ""; }
public class Par_PascalDst { public int UserId { get; set; } public string UserName { get; set; } = ""; }
[DwarfMapper(NameConvention = NameConvention.Flexible)] public partial class Par_FlexibleMapper // Mapster Flexible
{ public partial Par_PascalDst Map(Par_SnakeSrc s); }

public class Par_CiSrc { public int id { get; set; } public string name { get; set; } = ""; }
public class Par_CiDst { public int Id { get; set; } public string Name { get; set; } = ""; }
[DwarfMapper(CaseInsensitive = true)] public partial class Par_CaseInsensitiveMapper // Mapster IgnoreCase / Mapperly CaseInsensitive
{ public partial Par_CiDst Map(Par_CiSrc s); }

public class Par_HookSrc { public int Id { get; set; } }
public class Par_HookDst { public int Id { get; set; } public string Audit { get; set; } = ""; }
[DwarfMapper] public partial class Par_HookMapper             // AutoMapper Before/AfterMap, Mapster Before/AfterMapping
{
    [MapIgnore(nameof(Par_HookDst.Audit))]
    public partial Par_HookDst Map(Par_HookSrc s);
    [AfterMap] private static void Stamp(Par_HookSrc s, Par_HookDst d) => d.Audit = $"src#{s.Id}";
}

public class Par_ScalarSrc { public int Count { get; set; } public string Amount { get; set; } = ""; }
public class Par_ScalarDst { public long Count { get; set; } public int Amount { get; set; } }
[DwarfMapper] public partial class Par_ScalarMapper           // built-in widening + IParsable, all libraries
{ public partial Par_ScalarDst Map(Par_ScalarSrc s); }

public class Par_Money { public int V { get; set; } }
public class Par_MoneyDto { public int V { get; set; } public string Via { get; set; } = ""; }
public class Par_UmSrc { public Par_Money Amount { get; set; } = new(); }
public class Par_UmDst { public Par_MoneyDto Amount { get; set; } = new(); }
[DwarfMapper] public partial class Par_UserMethodMapper       // Mapperly [UserMapping] / AutoMapper ConvertUsing precedence
{
    ...
    private static Par_MoneyDto Convert(Par_Money m) => new() { V = m.V, Via = "user" };
}
#endregion
...
public class LibraryParityRuntimeTests
{
    ...
    public void Flattening_parity()
        => Assert.Equal("Brno", new Par_FlattenMapper().Map(new Par_FlatSrc { Address = new() { City = "Brno" } }).City);

    // Mapperly / AutoMapper deep source path.
    [Fact]
    public void Deep_source_path_parity()
        => Assert.Equal("Ada", new Par_DeepPathMapper().Map(new Par_PathSrc { Customer = new() { Name = "Ada" } }).CustomerName);
