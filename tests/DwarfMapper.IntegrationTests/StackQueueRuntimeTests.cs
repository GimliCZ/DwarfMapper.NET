...
// source order.
    ...
    public class StackQueueRuntimeTests
    {
        ...
        {
            var dto = new StackQueueMapper().ToQueue(new SqSrc
            {
                Values = new List<int>
                {
                    1,
        ...
        {
            var dto = new StackQueueMapper().ToStack(new SqSrc
            {
                Values = new List<int>
                {
                    1,
        ...
        public void List_to_Stack_to_list_round_trips()
        {
            ...
            var stack = new StackQueueMapper().ToStack(new SqSrc
            {
                Values = original
            });
        ...
        {
            var empty = new StackQueueMapper().ToStack(new SqSrc
            {
                Values = new List<int>()
            });
            ...
            var nullSrc = new StackQueueMapper().ToQueue(new SqSrc
            {
                Values = null!
            });
