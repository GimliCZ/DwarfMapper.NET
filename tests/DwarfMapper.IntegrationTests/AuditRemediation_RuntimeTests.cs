...
// fixture type names carry the FG (flatten-graph) prefix of the scenarios they belong to
...
// ═══════════════════════════════════════════════════════════════════════════════
    ...
    public class AuditRemediation_RuntimeTests
    {
        ...
        public void SfF4_InterfaceTypedEdge_two_chained_nodes_both_collected()
        {
            ...
            var b = new FGNodeImpl
            {
                Name = "b",
                Link = null
            };
            var a = new FGNodeImpl
            {
                Name = "a",
                Link = b
            };
            ...
            var result = mapper.Map(new FGIfaceRoot
            {
                Entry = a
            });
