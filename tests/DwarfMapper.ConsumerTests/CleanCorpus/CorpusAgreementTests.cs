...
namespace CleanCorpus
{
    ...
    public class CorpusAgreementTests
    {
        ...
        private static CatalogueItem APlainItem()
        {
            return new CatalogueItem
            {
                ...
                {
                    Name = "Kestrel",
                    Imprint = "Kestrel Classics"
                }
            };
        }

        private static AudioBook AnAudioBook()
        {
        ...
        public void The_member_with_a_non_public_constructor_agrees()
        {
            ...
            {
                DisplayName = "R. Aldous",
                CardNumber = "LIB-4471",
                EmailAddress = "r@example.invalid",
        ...
        {
            var source = ALoan(new DateOnly(2026, 2, 2));
        ...
        {
            var page = new Page<CatalogueItem>
            {
                Items = [APlainItem()],
                PageNumber = 2,
                TotalPages = 7
        ...
        {
            return typeof(Availability).GetField(value.ToString())!
