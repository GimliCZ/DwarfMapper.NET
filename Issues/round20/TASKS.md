...
| | |
|---|---|
| **In flight** | **A8 review** — implementation done, under task review. |
| **Next** | **A9**, then **A10 last among the refusal tasks**, then A11. (A5, A6, A7 and A8 are done; A6 is `PARTIAL` and A8 narrowed `D9` — both wait on A10.) |
...
**12 divergence findings · 62 declared cells · 294 unjudged-but-counted cells across four ratchets.**
